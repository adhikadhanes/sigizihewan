...
class PembeliansController extends Controller
{
	...
	public $view_col = 'Tgl Pembelian';
	public $listing_cols = ['id', 'tgl_pembelian', 'nama_penjual', 'tanggal_penerimaan', 'cara_penerimaan', 'cara_pembayaran', 'tgl_jatuh_tempo', 'gdg_penerimaan', 'so_id'];
	...
	public function tambahpembelian()
	{
		...
		return view('la.pembelians.add', compact('relationList','jenisList', 'merkList'));
