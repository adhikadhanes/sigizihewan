...
<div class="box box-success box-solid">
	<div class="box-header ">TAMBAH TRANSFER</div>
	<div class="box-body ">
	<div class="row">
		<div class="col-md-6">
...
<table>
  <tr>
    <td><strong>IDTRF </strong></td>
        <td width="20%"> : </td>
        <td style="font-weight: bold;">#TRF0001</td>
  </tr>
  <tr>
    <td><strong>Tanggal </strong> </td><td width="20%"> : </td>
    <td>{!! Form::date('name', \Carbon\Carbon::now(), ['class' => 'form-control']); !!} </td>
  </tr>
  <tr>
    <td><strong>Tanggal Pengiriman </strong> </td><td width="20%"> : </td>
    <td>{!! Form::date('name', \Carbon\Carbon::now(), ['class' => 'form-control']); !!} </td>
  </tr>
</table>
